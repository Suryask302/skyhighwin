const menu = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      {
        text: "Boosting Board Income",
        link: "/boostingIncome",
      },
      {
        text: "Skyforce Boosting Income",
        link: "/skyforceBoosting",
      },
      {
        text: "Team Promotion Bonus",
        link: "/teamPromoBonus",
      },
    ],
  },
  ...
  {
    icon: "coins",
    text: "Autopool Status",
    active: false,
    subMenu: [
      {
        text: "White Force Pool",
        link: "/whiteForcePool",
      },
      {
        text: "Blue Force Pool",
        link: "/blueForcePool",
      },
      {
        text: "Green Force Pool",
        link: "/greenForcePool",
      }
    ],
  }
