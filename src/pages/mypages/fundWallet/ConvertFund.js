...
import { Button, Form, FormGroup, Card, CardText, CardBody, CardTitle } from 'reactstrap'
                ...
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent className='mb-0 pb-0'>
                            <BlockTitle page>CONVERT FUND</BlockTitle>
                            <BlockDes>
                                convert fund to wallet
                            </BlockDes>
                        </BlockHeadContent>
                    </BlockBetween>
                </BlockHead>
                ...
                <Row className="g-gs">
                    ...
                    <Col md="8">
                        <PreviewAltCard className="card-full d-flex">
                            <CardTitle> <h6>Convert withdrawal wallet balance to Fund wallet</h6> </CardTitle>
