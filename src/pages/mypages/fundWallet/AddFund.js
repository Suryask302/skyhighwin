...
import { BlockHead, BlockBetween, BlockHeadContent, BlockTitle, PreviewAltCard, RSelect, Row, Col, BlockDes } from '../../../components/Component'
                ...
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent className='mb-0 pb-0'>
                            <BlockTitle page>Add Fund</BlockTitle>
                            <BlockDes>
                                add fund to fund wallet
                            </BlockDes>
                        </BlockHeadContent>
                    </BlockBetween>
                </BlockHead>
