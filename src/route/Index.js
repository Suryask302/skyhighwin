...
import WithdrawHistory from "../pages/mypages/WithdrawHistory";
...
import BoosterBoard from "../pages/mypages/boosting/BoosterBoard";
...
import LevelIncome from "../pages/mypages/incomeReports/LevelIncome";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/myTeam`} component={Directref}></Route>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/withdrawHistory`} component={WithdrawHistory}></Route>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/p2pTransfer`} component={P2pTransfer}></Route>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/boostingBoard`} component={BoosterBoard}></Route>
